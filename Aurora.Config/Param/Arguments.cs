...
namespace Aurora.Configs.Param
{
    ...
    public class Arguments
    {
        ...
        /// <summary>
        /// evaluates the commandline arguments and constructs the Named and Indexed parameter list
        /// </summary>
        ...
        {
            return (m_NamedParameters.ContainsKey(paramName));
        }
        /// <summary>
        ...
        public T GetParameter<T>(string param)
        {
            ...
            try
            {
                retVal = (T)(object)(m_NamedParameters[param]);
            }
            catch { }
            return (retVal);
        }
